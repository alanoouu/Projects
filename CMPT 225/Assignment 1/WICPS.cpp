 ...
 * WICPS.cpp
 *
 * Class Description: Patient database application.
 *
...
void modify(List *patients) {
    ...
    if (patients->getElementCount() != 0) {
        ...
        Patient *changeMem = patients->search(careCard);
